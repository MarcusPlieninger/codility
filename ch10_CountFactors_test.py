...
For example, given N = 24, the function should return 8, because 24 has
8 factors, namely 1, 2, 3, 4, 6, 8, 12, 24. There are no other factors
of 24.
...
import unittest
from ch10_CountFactors import solution
